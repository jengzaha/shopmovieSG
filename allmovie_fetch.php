		...
		foreach($result as $row)
		{
			...
			<div class="col-lg-4 col-md-5 col-sm-6">
				<div style="border:1px solid #ccc; border-radius:5px; padding:16px; margin-bottom:1px; height:450px;">
					...
					<a href="movie_details.php?pass='.$row['id'].'" class="btn btn-primary" style="margin-left: 40px;margin-top: -80px;">Buy ticket</a>
			</div>
			';
		...
		if($row['action']== "upcoming"){
			...
			<div class="col-lg-4 col-md-5 col-sm-6">
				<div style="border:1px solid #ccc; border-radius:5px; padding:16px; margin-bottom:1px; height:450px;">
					...
					<a href="movie_details.php?pass='.$row['id'].'" class="btn btn-primary" style="margin-left: 40px;margin-top: -80px;">coming soon</a>
			</div>
			';
		}
	}
