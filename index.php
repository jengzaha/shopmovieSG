...
<div class="container">
   <img src=image/cinema.png alt="" class="image-resize" style="width: 100%; height: 400px;">
</div>

<div class="container">
    <h2>Movies is showing</h2>
     <div class="row">
<?php
            ...
            <div class="running-movie">
             <img src=admin/image/<?php echo $row['image']; ?> alt="" class="image-resize2" style="width: 100%;">
              <div class="top-right">
               ...
               <a href="movie_details.php?pass=<?php echo $row['id'];?>" class="btn btn-primary">Buy ticket</a>
            </div>
           </div>
