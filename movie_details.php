...
<?php
  ...
  <div class="modal-dialog" role="document">
    ...
    <?php
// ตั้งค่าค่าสำหรับตัวแปรเซสชัน description
$_SESSION['description'] = "The story begins by returning to the past, where Gojo Satoru, Geto Suguru, and Leiri Shoko are all sophomore students in a vocational college. At the age of only 16";

// ต่อไปคุณสามารถใช้ตัวแปร $_SESSION['description'] ในโค้ด HTML ได้
?>
