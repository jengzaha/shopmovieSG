...
<body>
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6">TICKET SUMMARY</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="form-group"> <label for="username">
                                        <h6>Card Owner</h6>
                                    </label> <input type="text" id="card_name" name="card_name" placeholder="Card Name" class="form-control"> 
                                    <div id="validatecardname"></div>
                                </div>
                                <div class="form-group"> <label for="cardNumber">
                                        <h6>Card number</h6>
                                    </label>
                                    <div class="input-group"> <input type="text" id="card_number" name="card_number" placeholder="card number" class="form-control"> 
                                     </div>
