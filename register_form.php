...
<body>
  ...
  <div class="container">
    <center><a href="./index.html"><img src="img/logo1.png" alt="" style="margin-top: 80px; width: 50%;"></a></center>
  ...
  function validate()
{
 ...
 if( name.value == "" )
 {
  error = " <font color='red'>!plz Name.</font> ";
...
if(!isNaN(name.value)) 
{
 ...
 {
  error = " <font color='red'>!plz Email.</font> ";
 ...
 {
  error = " <font color='red'>!plz Number.</font> ";
  ...
  if(password.value.length >= 10) 
{
 ...
 {
  error = " <font color='red'>!plz password.</font> ";
